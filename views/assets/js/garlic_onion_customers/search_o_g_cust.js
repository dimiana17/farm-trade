$(document).ready(function () {
    let fetchedData = []; // Initialize fetchedData at the top
    ...
    $("#searchOGCustomers").click(function () {
        let customerName = $("#oGCustomerName").val().trim();
        let customerDate = $("#oGCustomerDate").val();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (customerName) {
                    $.ajax({
                        method: 'GET',
                        url: `http://localhost:3000/api/oniongarliccustomers/sums/name/${customerName}`,  // Ensure this URL is correct
