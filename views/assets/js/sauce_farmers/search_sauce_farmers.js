$(document).ready(function () {
    ...
    $("#searchSauceFarmers").click(function () {
        let customerName = $("#sauceFarmerName").val().trim();
        let customerDate = $("#sauceFarmerDate").val();
        ...
        $.ajax({
            method: 'GET',
            url: `http://localhost:3000/api/saucefarmers/search?${queryString}`, // Corrected URL string
                ...
                data.forEach(function(sauceFarmer) {
                    ...
                    $(".sauce-farmer-table-body").append(`
                        <tr data-id="${sauceFarmer._id}">
                            ...
                            <td><button class="sauce-bill-farmer-btn">فاتورة</button></td>
                        </tr>
                    `);
                });
