    ...
    $("#fetchFarmers").click(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $(".farmer-table-body").on("click", ".edit-btn", function () {
                    const farmerId = $(this).closest("tr").attr("data-id");
                    editFarmer(farmerId);
                });
    
                $(".farmer-table-body").on("click", ".delete-btn", function () {
                    const farmerId = $(this).closest("tr").attr("data-id");
                    deleteFarmer(farmerId);
                });
                $(".farmer-table-body").on("click", ".bill-farmer-btn", function () {
                        const farmerId = $(this).closest("tr").attr("data-id");
...
function saveBillAsImage() {
    ...
    function downloadExcel(filename) {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "Farmers Data"); // Append the sheet to the workbook
        XLSX.writeFile(wb, filename); // Trigger the download
    };

    $("#downloadFarmers").click(function () {
        downloadExcel("farmers_data.xlsx");
    });
