...
function saveBillAsImage() {
    ...
    // Ensure table is loaded and trigger download on button click
    $("#downloadFarmers").click(function () {
        // Call fetchFarmersForToday first if needed
        fetchFarmersForToday().then(() => {
    ...
    $("#fetchTodayFarmers").click(function(){
