...
const farmerController = require('../controllers/onion_garlic_farmer_controller'); // Adjust the path as needed

router.get('/search', farmerController.searchOnionGarlicFarmers);
router.get('/month', farmerController.getOGFarmersByMonth);
...
router.route('/')
    ...
    .delete(farmerController.deleteAllOGFarmers);
